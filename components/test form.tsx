        ...
        <div className="relative w-full max-w-lg lg:max-w-xl z-10">
          <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-10 lg:p-12 w-full border border-gray-100 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Watch your inbox — you'll get a welcome email soon with next steps and
              early access info.
            </p>
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-8">
              ...
              <div className="space-y-3 text-left">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700">
                    Get access to mentorship and beta features
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-700">
                    Earn your Founding Member badge
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="w-full bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-semibold text-base transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-block"
              >
                👉 Join WhatsApp Community
              </a>

              <Link href="/">
                <button className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-base transition-all duration-300">
                  Back to Home
                </button>
              </Link>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <p className="text-sm text-gray-500">
                You're joining{" "}
                <span className="font-semibold text-blue-600">500+</span> students
      ...
      <div className="relative w-full max-w-lg lg:max-w-xl z-10">
        ...
        >
          ...
          <button
            ...
            } text-white py-3 sm:py-4 rounded-xl font-semibold text-sm sm:text-base transition-all duration-300 transform hover:scale-105 hover:shadow-xl shadow-purple-200`}
          >
            {isLoading ? (
